...
\begin{frame}{Financial motivation to improve the official load forecast}
  ...
  \vspace{-0.5em}
  \[
    \underbrace{|e_t|}_{\text{imbalance volume}}
    \;\times\;
    \underbrace{|\mathrm{SMP}_t - \mathrm{MCP}_t|}_{\text{price spread}}
    \;\approx\;
    \text{balancing-market exposure}
  \]
  \vspace{-0.3em}
  \[
    \text{Better forecast}
    ...
    \;\Longrightarrow\;
    \text{less corrected in real time}
    \;\Longrightarrow\;
  ...
  \begin{columns}
    \begin{column}{0.60\textwidth}
      \small
      SMP is determined in real time under scarcity or surplus
      and is typically more volatile than the day-ahead MCP.
      Forecast errors therefore expose the system to an uncertain
      and potentially costly price spread.
    \end{column}
    \begin{column}{0.37\textwidth}
      \begin{block}{}
        \centering\small
        \textbf{Benchmark:} TEİAŞ official
        day-ahead load forecast\\[0.2em]
        \footnotesize\textit{Yük Tahmin Plan\i}\\
...
% ============================================================
\begin{frame}{Another note: official forecast persistently underpredicts}
  \begin{columns}
