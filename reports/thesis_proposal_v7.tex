...
\begin{frame}{The problem and the stakes}
  \begin{columns}
    ...
    \begin{column}{0.52\textwidth}
      ...
      \end{itemize}
      \vspace{0.5em}
      Our model \textbf{sidesteps} the question:
      rolling-origin re-estimation adapts at every
      forecasting step, regardless of cause.
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{FPCA: two scores capture the curve (Sub-Q1)}
  \begin{columns}
    ...
    \begin{column}{0.37\textwidth}
      ...
      $\Rightarrow$ static FPCA justified.
