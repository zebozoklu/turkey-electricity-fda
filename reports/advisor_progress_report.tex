...
This project studies day-ahead forecasting of Turkish electricity demand. The raw
...
are included because Turkish electricity demand changes around weekends, fixed
...
Finally, the adaptive correction step addresses systematic residual patterns that
remain after the score model. If recent forecasts have been too high or too low at
particular hours, the correction uses those recent residual curves to adjust the
base forecast. This is not a replacement for the FPCA model; it is a local
post-processing step designed to correct short-run bias and intraday error patterns.
...
ramp information, derivative information, and then adaptive correction of recent
residual errors.
